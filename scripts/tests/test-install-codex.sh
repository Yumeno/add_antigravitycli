...
check installs_skills t_install;check no_legacy_placeholders t_placeholders;check bundled_helpers t_helpers;check preserves_unrelated_and_replaces_stale t_preserve;check idempotent_and_absorbs_new t_idempotent;check readonly_preserves_prior_content t_readonly;check cleans_artifacts t_clean
